                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            <form role="form" action="house?action=houseEdit" data-toggle="validator modal"
                                  method="post">
                                <div class="form-group">
                                    <div class="input-group col-md-3">
                                        <label class="control-label">门牌号*</label>
                                        <input type="text" class="form-control" name="num" value="${house.num }"
                                               required>
                                ...
                                <div class="form-group">
                                    <div class="input-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="dep" value="${house.dep }"
                                               required>
                                        <span class="help-block with-errors"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="unit" value="${house.unit }"
                                               required>
                                        <span class="help-block with-errors"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group col-md-3">
                                        ...
                                        <input type="number" class="form-control" name="floor" value="${house.floor }"
                                               required>
                                        <span class="help-block with-errors"></span>
                                    </div>
                                </div>
