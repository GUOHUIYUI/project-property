            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li class="active"><a class="ajax-link" href="admin?action=adminList"><i
                            ...
                            <form action="admin?action=adminEdit" method="post" data-toggle="validator">
                                ...
                                <div class="form-group">
                                    <div class="input-group col-md-1">
                                        ...
                                        <input type="number" class="form-control" name="age" value="${admin.age}"
                                               required/>
                                        <span class="help-block with-errors"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="addr" value="${admin.addr}"
                                               required/>
                                        <span class="help-block with-errors"></span>
                                    </div>
                                </div>
